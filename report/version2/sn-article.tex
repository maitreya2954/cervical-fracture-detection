...
\subsubsection{Segmentation}\label{subsubsec2}
...
Random Forest Classifier & 0.88 \\ \hline
EfficientNetV2 & 0.95 \\ \hline
\end{tabular}
\caption[]
	{\small Accuracies of the models for the segmentation}
\end{table}
